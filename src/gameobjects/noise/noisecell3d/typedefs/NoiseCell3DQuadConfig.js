 ...
 * @property {boolean | number[]} [noiseWrap=true] - Whether to make the noise wrap smoothly at the edge of the image. `noiseCells` must be integers for this to work properly. If an array of 3 numbers, it sets the wrap to that many cells.

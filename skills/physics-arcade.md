...
**Related skills files:** game-setup-and-config.md, sprites-and-images.md, tilemaps.md, groups-and-containers.md

## Quick Start

```js
// 1. Enable Arcade Physics in game config
const config = {
    type: Phaser.AUTO,
    width: 800,
    height: 600,
...
// 2. Create physics-enabled sprites in create()
function create () {
